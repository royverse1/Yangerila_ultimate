...
export default function FooterReveal() {
  ...
  return (
    <div ref={containerRef} className="relative w-full flex flex-col z-20">
      ...
      {/* 1. FUN FACT SECTION */}
      <section className="panel sticky top-0 w-full section-padding min-h-screen flex flex-col items-center justify-center text-center bg-[#030907] bg-[linear-gradient(to_bottom,#0d2a1c,#030907)] border-t border-emerald-900/50 shadow-[0_-20px_50px_rgba(0,0,0,0.8)] z-30">
      ...
      <section className="panel sticky top-0 w-full section-padding min-h-screen bg-[#0A0510] bg-[linear-gradient(to_bottom,#380a2b,#0A0510)] border-t border-fuchsia-900/50 flex flex-col items-center justify-center overflow-hidden shadow-[0_-20px_50px_rgba(0,0,0,0.8)] z-40">
      ...
      <section className="panel sticky top-0 w-full min-h-screen overflow-hidden flex flex-col justify-center bg-[#010505] bg-[linear-gradient(to_bottom,#08273d,#010505)] border-t border-blue-900/50 shadow-[0_-20px_50px_rgba(0,0,0,0.8)] z-50">
