    ...
    <div ref={containerRef} className="w-full flex flex-col shrink-0 relative pointer-events-auto border-t-[3px] border-ink-dark/10 bg-transparent">
      ...
      >
        <div className="w-full max-w-screen-2xl mx-auto h-full flex flex-col items-center justify-center relative py-12 md:py-24">
          ...
          <div ref={founderTitleRef} className="invisible mb-6 md:mb-16 flex flex-col items-center md:items-start w-full max-w-7xl">
            <span className="block text-[10px] md:text-xs font-black font-[family:var(--font-technical-sans)] tracking-[0.4em] text-accent-teal uppercase mb-2">Founder's Note</span>
          </div>
          ...
          <div className="w-full flex flex-col md:grid md:grid-cols-2 gap-6 md:gap-16 lg:gap-20 items-center justify-center max-w-7xl mx-auto flex-1 md:flex-none">
            ...
            <div className="flex flex-col items-start gap-3 md:gap-5 text-left relative w-full flex-1 md:flex-none justify-center">
              <h2 ref={founderQuoteRef} className="relative z-10 text-base sm:text-xl lg:text-3xl font-bold text-ink-dark leading-snug tracking-tight w-full font-[family:var(--font-elegant-serif)]">
              ...
              <div ref={founderAuthorRef} className="mt-4 md:mt-14 invisible flex flex-col items-center md:items-start relative z-10 border-t-2 border-ink-dark/20 pt-4 md:pt-5 w-full max-w-sm shrink-0">
                <p className="text-[9px] md:text-[11px] font-black font-[family:var(--font-technical-sans)] uppercase tracking-[0.3em] text-ink-medium mb-1 opacity-80">Lead Guitar Coach</p>
            ...
            <div ref={tiltCardRef} className="relative shrink-0 transform-style-3d cursor-crosshair invisible flex justify-center md:justify-end mt-4 md:mt-0 w-full h-[25vh] md:h-auto md:w-auto">
              <div className="founder_image_box w-auto h-full aspect-[3/4] md:w-[320px] lg:w-[400px] md:h-auto bg-paper-bg border-[10px] md:border-[16px] border-paper-bg shadow-[0_20px_50px_rgba(26,26,26,0.3)] overflow-hidden pointer-events-none">
      ...
      <div className="w-full h-dvh flex flex-col justify-center relative px-2 sm:px-6 md:px-12 lg:px-24 pt-6 md:pt-16 shrink-0 bg-transparent overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto w-full text-center px-4 shrink-0 mb-4 md:mb-6">
          <h2 className="text-accent-teal tracking-[0.3em] font-black font-[family:var(--font-technical-sans)] text-[9px] md:text-xs uppercase mb-1.5">Our Curriculum</h2>
          <h3 className="text-3xl md:text-5xl lg:text-6xl font-black text-ink-dark font-[family:var(--font-technical-sans)] uppercase tracking-tight mb-2">Featured <span className="text-accent-teal">Courses</span></h3>
        </div>
          ...
          {courseData.map((course, idx) => {
            ...
            return (
              <div
                ...
                className="panel-accordion flex flex-row md:flex-col relative overflow-hidden group cursor-pointer rounded-[1.5rem] md:rounded-[2.5rem] lg:rounded-4xl shrink border-2 border-ink-dark/10 will-change-[flex] shadow-sm"
                style={{
              ...
              >
                <div className="expanded-glow absolute inset-0 autoAlpha-0 pointer-events-none transition-opacity duration-300 z-0">
                  ...
                  <div className="absolute inset-0 border-[6px] border-accent-teal rounded-[1.5rem] md:rounded-[2.5rem] lg:rounded-4xl pointer-events-none z-10" />
                </div>
                ...
                <div className="normal-content relative z-10 w-full h-full flex flex-row md:flex-col items-center justify-between p-3 sm:p-4 md:p-6 lg:p-8 pointer-events-none">
                  <div className="flex flex-row md:flex-col items-center md:items-start gap-3 w-full shrink">
                    ...
                    <div className="w-full text-left flex flex-col items-start gap-0.5 sm:gap-1">
                      <h3 className="text-xs sm:text-sm md:text-lg lg:text-xl font-black font-[family:var(--font-technical-sans)] leading-tight uppercase tracking-tight tabular-nums truncate w-full" style={{ color: course.colorText }}>{course.title}</h3>
                      <p className="text-[7px] sm:text-[8px] md:text-[9px] tracking-[0.1em] font-black font-[family:var(--font-technical-sans)] uppercase tabular-nums" style={{ color: course.colorText, opacity: 0.8 }}>{course.price}</p>
                    </div>
                  </div>
                  <div className="flex flex-col items-end md:items-start text-right md:text-left gap-1 md:gap-3 w-full shrink">
                    <div className="hidden md:block text-[8px] md:text-xs tracking-widest uppercase mb-1 font-black font-[family:var(--font-technical-sans)] tabular-nums opacity-80" style={{ color: course.colorText }}>{course.stats}</div>
                    <div className="bg-accent-teal border-2 border-transparent py-1.5 md:py-2 px-2 sm:px-3 md:px-5 rounded-md sm:rounded-lg md:rounded-xl text-[7px] sm:text-[8px] md:text-[9px] font-black font-[family:var(--font-technical-sans)] uppercase tracking-widest tabular-nums shadow-md flex gap-1 justify-center items-center text-white transition-colors cursor-pointer group-hover:bg-white group-hover:text-accent-teal group-hover:border-accent-teal">Explore</div>
                  </div>
                </div>
                ...
                <div className="expanded-content absolute inset-0 z-20 autoAlpha-0 pointer-events-none p-4 sm:p-6 md:p-10 flex flex-col md:flex-row items-center justify-center md:justify-start gap-3 sm:gap-4 md:gap-10 w-full h-full overflow-y-auto scrollbar-hide shrink">
                  ...
                  <div className="relative z-10 flex-1 text-center md:text-left flex flex-col items-center md:items-start shrink justify-center h-full w-full text-paper-bg">
                    ...
                    <p className="stagger-item text-[11px] sm:text-xs md:text-base lg:text-lg leading-snug md:leading-relaxed font-[family:var(--font-elegant-serif)] font-medium mb-4 sm:mb-5 md:mb-10 max-w-lg shrink text-paper-bg/90">{course.desc}</p>
                    ...
                    <div className="stagger-item w-full flex flex-col sm:flex-row gap-2 sm:gap-3 md:gap-4 items-center justify-center md:justify-start shrink">
                      <div className="flex flex-col gap-0.5 sm:gap-1 items-center md:items-start border border-ink-dark/40 bg-ink-dark/50 p-1.5 sm:p-2 px-4 sm:px-5 rounded-lg sm:rounded-xl md:rounded-2xl shrink-0 tabular-nums text-paper-bg">
                        <span className="text-[8px] sm:text-[9px] md:text-[10px] uppercase font-black font-[family:var(--font-technical-sans)] tracking-widest opacity-70 tabular-nums">Price</span>
                        <span className="text-sm sm:text-lg md:text-xl font-black font-[family:var(--font-technical-sans)] tabular-nums">{course.price}</span>
                      </div>
                      <a href="#" className="py-2.5 px-6 sm:py-3 sm:px-8 md:py-4 md:px-8 rounded-md border-2 border-transparent hover:border-white hover:bg-transparent bg-accent-magenta text-white font-black font-[family:var(--font-technical-sans)] text-[9px] sm:text-[10px] md:text-xs uppercase tracking-widest shadow-[0_10px_30px_rgba(227,66,52,0.4)] pointer-events-auto transition-all tabular-nums">Enroll Now</a>
                    </div>
                  </div>
        ...
        <div className="w-full text-center mt-3 sm:mt-4 md:mt-6 z-10 relative px-4 shrink-0">
          <p className="text-[9px] sm:text-[10px] md:text-xs xl:text-sm font-medium font-[family:var(--font-technical-sans)] text-ink-dark/90 tracking-wide">
      ...
      <div className="w-full h-dvh flex flex-col justify-center relative px-2 sm:px-6 md:px-12 pt-16 md:pt-20 shrink-0 bg-transparent border-t-[3px] border-ink-dark/10 overflow-hidden">
        <div className="max-w-6xl mx-auto w-full text-center">
          <h2 className="text-accent-teal tracking-[0.3em] font-black text-xs uppercase mb-3 md:mb-4 font-[family:var(--font-technical-sans)]">Exclusive Perks</h2>
          <h3 className="text-3xl sm:text-4xl md:text-6xl font-black text-ink-dark uppercase tracking-tight mb-6 md:mb-16 tabular-nums font-[family:var(--font-technical-sans)]">Premium <span className="text-accent-teal">Rewards</span></h3>
            ...
            {[
              ...
              >
                <div className="absolute inset-0 backface-hidden bg-paper-bg p-3 sm:p-5 md:p-8 rounded-xl md:rounded-[2rem] flex flex-col items-center justify-center border-2 border-ink-dark/20 text-center shadow-md">
                  ...
                  <p className="text-ink-medium text-[7px] sm:text-[8px] md:text-xs font-black font-[family:var(--font-technical-sans)] uppercase tracking-[0.1em] md:tracking-widest tabular-nums">{bonus.desc}</p>
                  <p className="text-[6px] sm:text-[7px] md:text-[10px] text-ink-dark/60 font-black font-[family:var(--font-technical-sans)] mt-2 md:mt-4 uppercase tracking-widest">Tap to reveal</p>
                </div>
                <div className="absolute inset-0 backface-hidden bg-accent-magenta p-3 sm:p-5 md:p-8 rounded-xl md:rounded-[2rem] flex flex-col items-center justify-center border-[4px] border-accent-magenta shadow-[0_15px_40px_rgba(227,66,52,0.4)] text-center" style={{ transform: 'rotateY(180deg)' }}>
                  <h4 className="text-[9px] sm:text-sm md:text-xl font-black font-[family:var(--font-technical-sans)] text-white mb-1 md:mb-3 uppercase tracking-[0.1em] md:tracking-widest tabular-nums">{bonus.desc}</h4>
      ...
      <div ref={admissionSectionRef} className="w-full h-dvh flex flex-col items-center justify-center text-center relative px-4 sm:px-6 md:px-12 pt-16 md:pt-20 shrink-0 bg-transparent overflow-hidden">
        <h2 className="admission-headline text-3xl sm:text-5xl md:text-8xl font-black text-ink-dark font-[family:var(--font-technical-sans)] mb-4 md:mb-8 uppercase tracking-tight tabular-nums invisible">
          Admissions <br />
        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-6 lg:gap-8 justify-center items-center w-full max-w-2xl mx-auto relative z-10 px-4">
          <a href="#" className="adm-btn bg-paper-bg hover:bg-white w-full sm:w-auto text-center px-6 py-3.5 sm:px-8 sm:py-5 md:px-12 md:py-6 rounded-full text-ink-dark font-black font-[family:var(--font-technical-sans)] tracking-widest uppercase border-2 border-ink-dark/20 premium-glow invisible text-[10px] md:text-sm tabular-nums transition-colors">Free Demo Session</a>
          <a href="#" className="adm-btn bg-accent-teal hover:bg-ink-dark w-full sm:w-auto text-center text-white px-6 py-3.5 sm:px-8 sm:py-5 md:px-12 md:py-6 rounded-full font-black font-[family:var(--font-technical-sans)] tracking-widest uppercase border-2 border-transparent premium-glow invisible text-[10px] md:text-sm tabular-nums transition-colors">Begin Admissions</a>
        </div>
      </div>
